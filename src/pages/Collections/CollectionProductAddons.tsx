...
const CollectionProductAddons = () => {
  ...
  const validateBeforeFinalize = () => {
    if (!navigationState) {
      return "Không tìm thấy dữ liệu nền đã chọn. Vui lòng quay lại bước chọn nền.";
    }
  ...
  const handleFinalize = (mode: "cart" | "buy-now") => {
    ...
    const nextItem = addItem({
      ...
      legoSelections: navigationState.legoSelections,
      totalLegoCount: navigationState.totalLegoCount,
      selectedAdditionalLegoCount: navigationState.selectedAdditionalLegoCount,
    ...
    return (
      <div className="cao-page">
        <div className="cao-error container">
          ...
          <Link
            to={`/bo-suu-tap/${slug}/san-pham/${productId}/chon-nen`}
  ...
  return (
    <>
      <SEO
        ...
        keywords={`${product.name}, option mua thêm, ấn phẩm tùy chỉnh, Soligant`}
      />
...
export default CollectionProductAddons;
