...
import {
  ...
  type BearCustomizerNavigationState,
...
const CollectionBearBackgroundPicker = () => {
  const { slug, productId } = useParams<{ slug: string; productId: string }>();
  const location = useLocation();
  const navigate = useNavigate();
  const customizerState = location.state as BearCustomizerNavigationState | null;
  ...
  const {
    ...
    queryKey: ["public-backgrounds", "bear"],
    queryFn: () => getPublicBackgrounds({ productType: "bear" }),
  ...
  const handleContinueToAddons = () => {
    ...
    const navigationState: BearAdditionalOptionsNavigationState = {
      bearSelections: customizerState.bearSelections,
      totalBearCount: customizerState.totalBearCount,
      selectedAdditionalBearCount: customizerState.selectedAdditionalBearCount,
              ...
              {customizerState && (
                <div className="cbp-summary__pricing">
                  <div className="cbp-summary__pricing-row">
                    <span>Tổng Gấu tùy chỉnh</span>
                    <strong>{customizerState.totalBearCount}</strong>
                  </div>
                  <div className="cbp-summary__pricing-row">
                    <span>Gấu thêm</span>
                    <strong>
                      {customizerState.selectedAdditionalBearCount}
                    </strong>
                  </div>
                  <div className="cbp-summary__pricing-row">
                        ...
                        return (
                          <div key={fieldKey} className="cbp-form-field">
                            ...
                            {field.fieldType === "select" &&
                              selectType === "dropdown" && (
                                <select
                                  className="cbp-input cbp-select"
                                  value={
                                    typeof selectedValue === "string"
                                      ? selectedValue
                                      : ""
                            ...
                            {field.fieldType === "select" &&
                              selectType === "checkbox" && (
                                <div className="cbp-checkbox-group">
                                  {field.options.map((option) => {
...
export default CollectionBearBackgroundPicker;
